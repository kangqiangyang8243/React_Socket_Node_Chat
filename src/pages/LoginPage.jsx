...
function LoginPage() {
  ...
  return (
    <div className="w-full h-screen bg-[#2a2c36] flex justify-center px-10 items-center">
      <div className="bg-[#16151c] flex flex-col font-serif w-[450px] h-[500px] rounded-lg shadow-lg">
        {/* TOP */}
        ...
        >
          ...
          <button
            type="submit"
            className="w-[90%] mb-4 transform duration-150 ease-linear hover:bg-purple-400 font-bold text-lg text-white rounded-lg p-2 bg-purple-500"
          >
            SIGN IN
          </button>
          <p className=" whitespace-nowrap text-white text-sm uppercase w-full text-center tracking-wider -mt-5">
            Don't Have a ACCOUNT?{" "}
            <Link
              to="/register"
              className="hover:text-blue-300 text-indigo-600"
            >
              Register
            </Link>
          </p>
